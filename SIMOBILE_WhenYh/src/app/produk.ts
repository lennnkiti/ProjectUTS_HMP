...
export class Produk { // Sesuaikan nama class jika filenya produk.service.ts
  
  // Array of Objects untuk menampung 10 dummy data
  public dataProduk = [
  ...
  // Fungsi untuk Dashboard: Menghitung total macam produk
  getTotalMacamProduk(): number {
    return this.dataProduk.length;
  }

  // Fungsi untuk Dashboard: Mencari produk paling banyak terjual
  getProdukTerlaris() {
  ...
  // Fungsi untuk mengambil detail 1 produk berdasarkan ID
